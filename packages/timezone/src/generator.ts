...
import { TimezoneOptions, ITimezoneGenerator, Timezone } from "./interfaces";

export class TimezoneGenerator extends Generator implements ITimezoneGenerator {
  public timezone(options?: TimezoneOptions): Timezone {
    return pickOne({ array: this.getTimezonesData() });
  }
  private getTimezonesData(): Array<Timezone> {
    return [
      {
