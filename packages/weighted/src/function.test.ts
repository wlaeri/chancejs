import { weighted } from "./function";
import { times } from "@chancejs/generator";

describe("::Miscellaneous ::weighted()", () => {
  ...
  describe("when weighted works with just 2 items", () => {
  ...
  describe("when weighted works with just 4 items", () => {
  ...
  describe("when weighted works with fractional weights", () => {
    it("returns good ratios", () => {
      let picked = { a: 0, b: 0, c: 0, d: 0 };
      times(50000, () => {
        picked[
