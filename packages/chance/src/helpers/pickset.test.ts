...
describe("::Chance ::Helpers ::pickSet", () => {
  let chance: Chance;
  beforeEach(() => {
    chance = new Chance();
  });
  describe("When count is 0", () => {
    it("returns empty array", () => {
      const arr = ["a", "b", "c", "d"];
      times(1000, () => {
        const picked = chance.pickSet({ array: arr, count: 0 });
  ...
  describe("When count isn't provided", () => {
    it("returns single element array", () => {
      const arr = ["a", "b", "c", "d"];
      times(1000, () => {
        const picked = chance.pickSet({ array: arr });
  ...
  describe("When count isn't positive number", () => {
    it("throws error", () => {
      const arr = ["a", "b", "c", "d"];
      const fn = () => chance.pickSet({ array: arr, count: -1 });
      expect(fn).toThrow(
  ...
  describe("When count is 1", () => {
    it("returns single element array", () => {
      const arr = ["a", "b", "c", "d"];
      times(1000, () => {
        const picked = chance.pickSet({ array: arr, count: 1 });
        expect(picked.length).toEqual(1);
        expect(Array.isArray(picked)).toEqual(true);
      });
    });
  ...
  describe("When count is > 1", () => {
    it("returns array with multiple elements", () => {
      const arr = ["a", "b", "c", "d"];
      times(1000, () => {
        const picked = chance.pickSet({ array: arr, count: 3 });
  ...
  describe("When count is greater than the size of the array", () => {
    it("returns no more values than the size of the array", () => {
      const arr = ["a", "b", "c", "d"];
      times(1000, () => {
        const picked = chance.pickSet({ array: arr, count: 5 });
  ...
  describe("When execute pickSet()", () => {
    it("it doesn't destroy the original array", () => {
      ...
      times(1000, () => {
        const cloned = [...arr];
        chance.pickSet({ array: cloned, count: 3 });
    ...
    it("it returns unique value", () => {
      const arr = ["a", "b", "c", "d"];
      times(1000, () => {
        const picked = chance.pickSet({ array: arr, count: 4 });
