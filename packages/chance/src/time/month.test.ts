...
describe("::Chance ::Time ::#month", () => {
  ...
  describe("When month() executes", () => {
    ...
    describe("with only min arg", () => {
      it("returns correct result", () => {
        times(1000, () => {
          let m = chance.month({ raw: true, min: 10 });
    ...
    describe("with only max arg", () => {
      it("returns correct result", () => {
        times(1000, () => {
          let m = chance.month({ raw: true, max: 10 });
    ...
    describe("with max and min args", () => {
      it("returns correct result", () => {
        times(1000, () => {
          let m = chance.month({ raw: true, min: 7, max: 10 });
  ...
  describe("When pass min arg with value greater than max arg", () => {
    it("throws error", () => {
      const fn = () => chance.month({ min: 10, max: 5 });
