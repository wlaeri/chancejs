...
// plop-imports
import { MinuteGenerator, MinuteOptions } from "@chancejs/minute";
...
export class Chance implements IChance {
  // plop-class-fields
  private minuteGenerator: MinuteGenerator;
  ...
  constructor(options?: ChanceOptions) {
    ...
    // plop-constructor
    this.minuteGenerator = new MinuteGenerator({ seed, generator });
  ...
  // plop-class-methods
  minute(options?: MinuteOptions): number {
    return this.minuteGenerator.minute(options);
  }
