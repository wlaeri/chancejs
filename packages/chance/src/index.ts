...
// plop-imports
import { YearGenerator, YearOptions } from "@chancejs/year";
...
export class Chance implements IChance {
  // plop-class-fields
  private yearGenerator: YearGenerator;
  ...
  constructor(options?: ChanceOptions) {
    ...
    // plop-constructor
    this.yearGenerator = new YearGenerator({ seed, generator });
  ...
  // plop-class-methods
  year(options?: YearOptions): string {
    return this.yearGenerator.year(options);
  }
