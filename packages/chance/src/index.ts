...
// plop-imports
import { AmpmGenerator, AmpmOptions } from "@chancejs/ampm";
...
export class Chance implements IChance {
  // plop-class-fields
  private ampmGenerator: AmpmGenerator;
  ...
  constructor(options?: ChanceOptions) {
    ...
    // plop-constructor
    this.ampmGenerator = new AmpmGenerator({ seed, generator });
  ...
  // plop-class-methods
  ampm(options?: AmpmOptions): string {
    return this.ampmGenerator.ampm(options);
  }
